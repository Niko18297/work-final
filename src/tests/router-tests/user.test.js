...
test("POST -> 'BASE_URL', should return status code 201, and res.body.email === user.email and res.body.id to be defined", async () => {
...
test("UPDATE -> 'BASE_URL/:id', should return status code 200, and res.body.firstName === userUpdate.firstName", async () => {
